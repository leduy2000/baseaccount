<form action="/baseaccount/login/user_login" method="POST">
    ...
    <div class="center grey subtitle">
    ...
    <div class="center btn-login">Login with SAML</div>
    <div class="center url-account-type"><a href="/baseaccount/login/guest">Login with Guest/Client access?</a></div>
</form>